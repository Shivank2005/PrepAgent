    ...
    <div className="flex flex-col items-center justify-center h-[100vh] w-[100vw] bg-[#0a0a0f] absolute inset-0 z-50 overflow-y-auto pt-10 pb-10">
      ...
      <div className="z-10 w-full max-w-md p-8 glass-card border border-[#2d2c41] rounded-2xl shadow-2xl bg-[#12121a]/80 backdrop-blur-xl mx-4 relative">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-[#a5a0c4] text-sm mt-1">Start your AI-powered interview prep today</p>
        </div>
        ...
        <button
          ...
          className="w-full bg-white hover:bg-gray-100 text-[#12121a] font-bold py-3 rounded-xl transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
        >
        ...
        <div className="mt-8 text-center text-sm text-[#5c5875]">
          ...
          <Link href="/login" className="text-[#8b5cf6] hover:text-[#a855f7] font-medium transition-colors">
            Log in
          </Link>
        </div>
      </div>
